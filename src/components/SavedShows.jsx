...
const SavedShows = () => {
  ...
  return (
    <section className="absolute top-[20%] p-4 md:p-8">
      <h1 className="font-bold text-3xl md:text-5xl">My Shows</h1>

      <div>
        <h2 className="text-white font-bold py-6 md:text-xl">Favourites</h2>
        <div className="flex items-center group">
          <div id={`slider`} className="relative w-full h-full">
            {movies.map((movie) => {
              return (
                <article key={movie.id} className="relative inline-block p-2 cursor-pointer w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px]">
